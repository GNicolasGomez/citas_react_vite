  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
      ...
      >
        ...
        <input
          type="submit"
          className="bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 cursor-pointer trannsition-colors"
